...
class Controller{
	...
	private function unserializeAuthenticator(){
		if(!isset($_SESSION['authenticator'])){
			$_SESSION['authenticator'] = serialize($this->authenticator);
		}
		$this->authenticator = unserialize($_SESSION['authenticator']);
	}
	
	private function serializeAuthenticator(){
		$_SESSION['authenticator'] = serialize($this->authenticator);
	}
